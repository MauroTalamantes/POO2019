...
public class JFrameCalculadora extends JFrame{
    ...
    private void inicializarComponentes() {
        ...
        JButtonC btnDate = new JButtonC(".", dim, Color.yellow);
        JButtonC btnEqual = new JButtonC("=", dim, Color.gray);
        JButtonC btnInfo = new JButtonC("?", dim, Color.yellow);
        ...
        panelCentral.add(btnDate);
        panelCentral.add(btnEqual);
        ...
        ListenerGris esc3 = new ListenerGris(display);
        ...
        btnInfo.addActionListener(esc2);
        btnDate.addActionListener(esc2);
        
        btnEqual.addActionListener(esc3);
